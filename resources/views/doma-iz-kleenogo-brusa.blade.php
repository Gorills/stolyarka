...
@section('content')
    ...
    @component('components.breadcrumb')
        @slot('title') Дома из клееного бруса @endslot
        ...
        @slot('active') Дома из клееного бруса @endslot
        @slot('activelink')  @endslot

        @slot('img') {{ URL::asset('images/breadcrumbs/doma-iz-kleenogo-brusa.jpg') }} @endslot
@endcomponent
