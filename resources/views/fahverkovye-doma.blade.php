...
@section('content')
    ...
    @component('components.breadcrumb')
        @slot('title') Фахверковые дома @endslot
        ...
        @slot('prevto') Каркасные дома @endslot

        @slot('linkto') {{ url('/stroitelstvo/karkasnye-doma') }} @endslot


        @slot('active') Фахверковые дома @endslot
        @slot('activelink')  @endslot

        @slot('img') {{ URL::asset('images/breadcrumbs/fahverkovye-doma.jpg') }} @endslot
@endcomponent
