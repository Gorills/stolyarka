        ...
        <div class="container">
            <div class="seotext__inner">
                ...
                <div class="seotext__text-wrapper">
                    <p class="seotext__text">Компания «Святобор-строй» специализируется на изготовлении и строительстве
                        готовыхдомов из бруса под ключ.</p>

                    <p class="seotext__text">Пиломатериал мы изготавливаем на собственной производственной базе. Это
                        позволяет нам быть уверенными в качестве бруса, который применяется при строительстве.</p>
                ...
                <div class="seotext__text-wrapper">
                    <p class="seotext__text">
                        Компания «Святобор-строй» заботится о качестве реализуемых строений и удобстве клиентов. У нас вы купите дом из бруса с максимальным количеством
                        выполняемых услуг.
                        При этом мы не навязываем своим покупателям лишние траты и берём на себя все расходы, связанные с арендой спецтехники и оборудования,
                        необходимого при строительстве, в отличие от других строительных компаний Томскп и Томской области.
                    </p>
                    <p class="seotext__text">
