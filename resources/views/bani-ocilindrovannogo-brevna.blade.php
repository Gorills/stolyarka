...
@section('content')
    ...
    @component('components.breadcrumb')
        @slot('title') Бани из оцилиндрованного бревна @endslot
        ...
        @slot('active') Бани из оцилиндрованного бревна @endslot
        @slot('activelink')  @endslot

        @slot('img') {{ URL::asset('images/breadcrumbs/bani-iz-ocilindrovannogo-brevna.jpg') }} @endslot
@endcomponent
